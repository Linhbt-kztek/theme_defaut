        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a class="logo logo-dark" href="<?php echo e(route('home')); ?>">
                        <span class="logo-sm">
                            <img alt="" height="22" src="<?php echo e(url('assets/images/logo-sm.png')); ?>">
                        </span>
                        <span class="logo-lg">
                            <img alt="" height="17" src="<?php echo e(url('assets/images/logo-dark.png')); ?>">
                        </span>
                    </a>
                    <a class="logo logo-light" href="<?php echo e(route('home')); ?>">
                        <span class="logo-sm">
                            <img alt="" height="22" src="<?php echo e(url('assets/images/logo-sm.png')); ?>">
                        </span>
                        <span class="logo-lg">
                            <img alt="" height="17" src="<?php echo e(url('assets/images/logo-light.png')); ?>">
                        </span>
                    </a>
                </div>
            </div>
                ...
                <div class="ms-sm-3 header-item topbar-user">
                    <div class="topbar-user dropdown">
                        <span class="d-flex align-items-center">
                            <img alt="Header Avatar" class="rounded-circle header-profile-user" src="<?php echo e($auth_avt); ?>">
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e($auth_name); ?></span>
                            </span>
                        </span>
                        <div class="dropdown-menu dropdown-content c-dropdown">
                            <a class="dropdown-item c-dropdown-item"
                                href="<?php echo e(route('user_edit', Auth::user()->id)); ?>?menu=1">
...
</script><?php /**PATH C:\laragon\www\theme_defaut\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>