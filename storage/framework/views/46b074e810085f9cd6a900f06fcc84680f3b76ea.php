...
<?php $__env->startSection('content'); ?>
    ...
    <div class="tasks-board mb-3" id="kanbanboard">
        <div class="tasks-list">
                ...
                <div id="unassigned-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
                                        class="link-secondary">Profile
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <li><a class="dropdown-item" href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"><i
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
                                            class="link-secondary">Velzon
            ...
            <div class="my-3">
                <button class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#creatertaskModal">Add
                    More</button>
            </div>
        </div>
        <!--end tasks-list-->
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>" class="link-secondary">Brand
                                    Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
            ...
            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        ...
                        <!--end card-body-->
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="55"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <!--end card-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\bui_linh_project\project_in_github\minimal-theme\resources\views/apps-tasks-kanban.blade.php ENDPATH**/ ?>