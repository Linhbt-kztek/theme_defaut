                ...
                <div class="card-header">
                    <div class="d-flex mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <a href="#" class="link-secondary text-decoration-underline">Clear All</a>
                        </div>
                    </div>
                                ...
                                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#productnav-published"
                                            role="tab">
                                            Published <span
                                                class="badge bg-secondary align-middle rounded-pill ms-1">5</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="py-4 text-center">
                                    <div>
                                        <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop"
                                            colors="primary:#25a0e2,secondary:#00bd9d" style="width:72px;height:72px">
                                        </lord-icon>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\bui_linh_project\project_in_github\minimal-theme\resources\views/apps-ecommerce-products.blade.php ENDPATH**/ ?>