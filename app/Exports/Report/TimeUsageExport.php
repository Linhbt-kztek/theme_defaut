...
class TimeUsageExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    {
        return view('export.report.time_usage_report', [
            'data' => $this->data,
        ]);
    }
