...
class RevenueReportCustomerClassificationExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    {
        return view('export.RevenueReport.revenue_report_customer_classification_export', [
            'data' => $this->data,
        ]);
    }
