...
class RevenueReportVoucherExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    {
        return view('export.RevenueReport.revenue_report_voucher_export', [
            'data' => $this->data,
