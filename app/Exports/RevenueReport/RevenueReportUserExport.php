...
class RevenueReportUserExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    {
        return view('export.RevenueReport.revenue_report_user_export', [
            'data' => $this->data,
        ]);
    }
