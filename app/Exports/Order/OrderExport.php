...
class   OrderExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
     * @return Collection
     */
    ...
    public function view(): View
    {
        ...
        return view('export.order.order_export', [
            'data' => $this->data,
        ]);
    }
    ...
    public function columnWidths(): array
    {
        return [
            'A' => 7,
            'B' => 25, //Nội dung đăng ký thi đấu
            'C' => 25, //Họ và tên VĐV
            'D' => 16, //Ảnh chân dung
            'E' => 25, //Giới tính
            'F' => 25, //Ngày/tháng/năm sinh
            'G' => 25, //Mã VĐV
            'H' => 20, //Chiều cao (cm)
        ];
    }
