...
class BillExport extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
     * @return Collection
     */
    ...
    {
       // dd($this->data["ticket"]);
        return view('export.order.bill', [
            'tickets' => $this->data["ticket"],
    ...
    public function columnWidths(): array
    {
        return [
            'A' => 20,
            'B' => 40, //Nội dung đăng ký thi đấu
            'C' => 40, //Họ và tên VĐV
            'D' => 20, //Ảnh chân dung
            'E' => 20, //Giới tính
            'F' => 20, //Ngày/tháng/năm sinh
            'G' => 20, //Mã VĐV
            'H' => 20, //Chiều cao (cm)
            'I' => 25, //Chiều cao (cm)
            'J' => 25, //Chiều cao (cm)
    ...
    public function registerEvents(): array
    {
        ...
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                //nôi dung-----------------------------
                for ($i = 0; $i < (count($this->data["ticket"]) + 1 + 3); $i++) {

                    //từ A13 -U13 :.....

                    //chiêu cao hàng
                    $event->sheet->getDelegate()->getRowDimension(($i + $this->row_header))->setRowHeight(20);
