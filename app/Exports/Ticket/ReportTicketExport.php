...
class ReportTicketExport  extends DefaultValueBinder implements FromView, WithColumnFormatting, WithCustomValueBinder, WithColumnWidths, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    {
        //  dd($this->list_search);
        return view('export.ticket.report_ticket_export', [
            'data' => $this->data,
        ]);
    }
