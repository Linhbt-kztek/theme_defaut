                ...
                <div id="unassigned-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <li><a class="dropdown-item" href="{{URL::asset('/apps-tasks-details')}}"><i
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}" class="link-secondary">Brand
                                    Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
