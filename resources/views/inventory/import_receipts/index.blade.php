    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <div class="page-title-left">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active"><b>Phiếu nhập</b></li>
            </ol>
        </div>
    </div>

    <div class="card" id="import-receipt-list">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-3 d-flex align-items-end justify-content-end">
                    <a href="{{ route('inventory.import-receipts.create') }}" class="btn btn-cyan btn-color-white text-nowrap"><i class="ri-add-fill"></i><span>Tạo phiếu</span></a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-light-custom align-middle table-nowrap mb-0">
                <thead class="table-light text-muted"><tr class="text-center"><th>Mã phiếu</th><th>Kho nhập</th><th>Trạng thái</th><th>Ngày tạo</th><th style="width: 12%">Thao tác</th></tr></thead>
                <tbody>
                @forelse($receipts as $receipt)
                    <tr>
                        ...
                        <td class="text-center"><a class="icon-edit icon-action" href="{{ route('inventory.import-receipts.show', $receipt->id) }}" title="Chi tiết"><i class="ri-eye-line"></i></a></td>
                    </tr>
                @empty
                    <tr><td colspan="5" class="text-center text-muted">Chưa có phiếu nhập.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
