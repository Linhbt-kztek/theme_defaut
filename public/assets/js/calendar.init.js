  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventDrop: function (info) {
      ...
      if (defaultEvents[indexOfSelectedEvent]) {
        ...
        defaultEvents[indexOfSelectedEvent].description = info.event._def.extendedProps.description
          ? info.event._def.extendedProps.description
          : ''
        defaultEvents[indexOfSelectedEvent].location = info.event._def.extendedProps.location
...
function flatPickrInit() {
  // Gán đúng element từ DOM
  var start_date = document.getElementById('event-start-date')
  var timepicker1 = document.getElementById('timepicker1')
  var timepicker2 = document.getElementById('timepicker2')

  // Nếu chưa có phần tử thì dừng lại để tránh lỗi
  if (!start_date || !timepicker1 || !timepicker2) {
    console.warn('⚠️ Flatpickr skipped — missing input elements in DOM')
    return
  }
