...
(function() {
    ...
    function twoColumnMenuGenerate() {
        ...
        if (defaultValues && (isTwoColumn == "vertical" || defaultValues["data-layout"] == "vertical")) {
            ...
            document.querySelector("#two-column-menu ul").querySelectorAll("li a").forEach(function(element) {
                ...
                if (currentPath == element.getAttribute("href-config") && !element.getAttribute("data-bs-toggle")) {
    ...
    function initActiveMenu() {
        ...
        if (currentPath) {
            // navbar-nav
            var a = document.getElementById("navbar-nav").querySelector('[href-config="' + currentPathServer + '"]');
            if (a) {
                a.classList.add("active");
                var parentCollapseDiv = a.closest(".collapse.menu-dropdown");
                if (parentCollapseDiv) {
...
var parentIdAcitve = $('a.active').attr('parent_id')
expanParentMenu(parentIdAcitve);
function expanParentMenu(id){
    $('a#' + id).attr('aria-expanded', 'true');
    $('#sidebar-' + id).addClass('show');
    if($('a#' + id).attr('parent_id')){
        expanParentMenu($('a#' + id).attr('parent_id'));
    }
    return;
}
