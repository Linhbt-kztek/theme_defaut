    ...
    function windowLoadContent() {
        ...
        document.getElementById("topnav-hamburger-icon").addEventListener("click", function () {
            ...
            if (document.body.classList.contains("menu-opened")) {
                setTimeout(() => {
                    document.querySelectorAll(".navbar-menu .navbar-nav .nav-link[data-bs-toggle='collapse']").forEach(function (link) {
                        if (link.getAttribute("aria-expanded") === "true") {
                            link.classList.add("no-padding");
                        } else {
                            link.classList.remove("no-padding");
                        }
                    });
                }, 300);
            } else {
                document.querySelectorAll(".navbar-menu .navbar-nav .nav-link.no-padding").forEach(function (link) {
                    link.classList.remove("no-padding");
                });
            }
        });
...
// Các logic sẵn có của bạn, giữ nguyên
var isValues = sessionStorage.getItem("defaultAttribute");
var defaultValues = JSON.parse(isValues);
var windowSize = document.documentElement.clientWidth;
